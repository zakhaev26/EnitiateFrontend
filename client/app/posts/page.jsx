...
const Card = () => {
  return <div style={cardStyle}>Card ContentCard ContentCard ContentCard ContentCard ContentCard ContentCard ContentCard ContentCard ContentCard ContentCard Content</div>;
};
